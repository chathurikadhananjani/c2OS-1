...
;===================================================================
	...
	BITS 16
	%DEFINE C2OS_VER '1.0.0'	 ;OS version number
	%DEFINE C2OS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	os_init_msg		db ' :) ;) Welcome to C2OS ;) :) ', 0
	os_version_msg		db 'Version ', C2OS_VER, 0

	os_init_msg2		db '                     --> Hardware Information <--                           ', 0
	os_version_msg2		db 'Version ', C2OS_VER, 0

	dialog_string_1		db ' This is C2 Operating System', 0
	dialog_string_2		db 'Please select H.info for HardwareInfo or', 0
...
os_draw_background1:
	...
	mov cx, 0001111b		; Colour: white text on light blue
...
os_hardware:
	...
	exitmsg			db	"--> Press ESC key to exit(esc)"
